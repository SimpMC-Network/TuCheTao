package me.typical.autocraft.config;
...
import me.typical.autocraft.config.types.MainConfig;
import me.typical.autocraft.config.types.MessageConfig;
import me.typical.autocraft.config.types.RecipesConfig;
import me.typical.autocraft.config.types.menu.RecipeListMenuConfig;
import me.typical.autocraft.config.types.menu.RecipeMenuConfig;
...
public class ConfigManager {
    ...
    private void register() {
        ...
        if (!getDataFolder().exists()) {
            ...
            YamlConfigurations.save(recipeMenuFile, RecipeListMenuConfig.class, new RecipeListMenuConfig());
            YamlConfigurations.save(recipeListMenuFile, RecipeMenuConfig.class, new RecipeMenuConfig());
        } else {
            ...
            YamlConfigurations.update(recipeMenuFile, RecipeListMenuConfig.class);
            YamlConfigurations.update(recipeListMenuFile, RecipeMenuConfig.class);
        }
